...
const Header = () => {
    ...
    return (
        <Container position="static" style={{ background: "#000000" }}>
            <Toolbar style={{ background: "#000000" }}>
                ...
                <Button
                    color="inherit"
                    style={{ textTransform: "none", background: "#444857" }}
                >
                    <CloudQueueIcon style={{ paddingRight: "4px" }} />
                    Save
                </Button>
                <Button
                    color="inherit"
                ...
                >
                    <SettingsIcon style={{ paddingRight: "3px" }} />
                    Settings
                </Button>
                <Button
                    style={{
